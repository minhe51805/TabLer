...
| ID | Evidence | Status |
| --- | --- | --- |
| ROAD-001 | `docs/UPGRADE_ROADMAP.md`, `docs/roadmap/EVIDENCE_TEMPLATE.md` | Verification; commit/review pending |
| CAP-001 | Rust catalog, generator, committed JSON matrix, contract tests | Verification; review pending |
...
- Link tracking issues and the implementation commit or pull request.
