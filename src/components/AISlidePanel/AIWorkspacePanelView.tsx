...
export interface AIWorkspacePanelViewModel {
  ...
  chatWorkspaces: { id: string; name: string; contextUpdatedAt: number | null }[]; importableChatThreads: AIChatThread[]; isCompacting: boolean;
