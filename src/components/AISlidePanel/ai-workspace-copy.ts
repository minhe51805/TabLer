...
const COPY: Record<AppLanguage, AIWorkspaceCopy> = {
  en: {
    ...
    composer: {
      ...
      inspectOffTitle: "Click to open AI composer, double click for inspect mode.",
  ...
  vi: {
    ...
    composer: {
      ...
      inspectOffTitle: "Bấm để mở AI composer, double click để vào chế độ inspect.",
  ...
  zh: {
    ...
    composer: {
      ...
      inspectOffTitle: "点击打开 AI 编辑器，双击进入 inspect 模式。",
