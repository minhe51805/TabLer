...
export const EN_COPY: AIWorkspaceCopy = {
    ...
    // Filter by label, database, or engine.
      ...
      modeEdit: "Edit",
      modeAgent: "Agent",
      modePromptHint: "Quick answers without schema context.",
      modeEditHint: "Suggest SQL from the current schema.",
      modeAgentHint: "Inspect the DB and auto-run with your approval.",
