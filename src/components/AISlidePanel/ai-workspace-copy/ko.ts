...
export const KO_COPY: AIWorkspaceCopy = {
    ...
    // 라벨, 데이터베이스 또는 엔진으로 필터링합니다.
      ...
      sqlConfirmWriteBody: "AI 에이전트가 데이터를 변경하는 문을 실행하려 합니다. 승인하기 전에 검토하세요.",
      sqlConfirmHighRiskTitle: "고위험 SQL을 실행할까요?",
      sqlConfirmHighRiskBody: "이 실행은 되돌릴 수 없는 스키마 변경을 할 수 있습니다. 모든 문을 신중히 검토하세요.",
      ...
      autonomyFullConfirmBody: "에이전트가 준비한 모든 SQL을 묻지 않고 자동 실행합니다. 쓰기 및 스키마 작업은 실행 전에 확인을 요청합니다.",
    ...
    workspace: {
      ...
      compactNeedsWorkspace: "/compact 이 컨텍스트를 저장할 수 있도록 먼저 채팅 워크스페이스를 만들어 주세요.",
