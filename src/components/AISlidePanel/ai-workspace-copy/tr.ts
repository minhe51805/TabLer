...
export const TR_COPY: AIWorkspaceCopy = {
  ...
  insights: {
    ...
    dismiss: "Yoksay",
    reviewFirst: "Çalıştırmadan önce inceleyin - bu öneri veriyi değiştirebilir",
    clearAll: "Tümünü temizle",
  },
  bubbleMeta: {
    thinking: "Düşünüyor",
  ...
  modal: {
    ...
    rewriteHint:
      "İstediğiniz değişikliği yazın, ardından AI'dan yeni bir versiyon yazmasını isteyin.",
    rewritePlaceholder:
      "Örnek: PostgreSQL için daha güvenli yap, yorum ekle, DDL ve DML'yi ayır veya join'leri daha açık açıkla.",
  ...
  composer: {
    ...
    resizeHandleTitle:
      "AI panelini yeniden boyutlandırmak için sürükleyin. Sıfırlamak için çift tıklayın.",
    ...
    checkpointPreviewBody:
      "Mevcut veritabanına {statements} ifade çalıştırılacak ({schema} şema, {data} veri, {destructive} yıkıcı).",
    ...
    dataReadToggleLabel: "Veri okuma",
    toggleConfirmTitle: "Değişikliği onayla",
    toggleConfirmMessageEnable: '"{feature}" açılsın mı?',
    toggleConfirmMessageDisable: '"{feature}" kapatılsın mı?',
    toggleConfirmConfirm: "Onayla",
    toggleConfirmCancel: "İptal",
    newChatTitle: "Yeni sohbet",
    reloadChatTitle: "Sohbeti kayıtlı geçmişten yeniden yükle",
    modeNeedsSchemaHint:
      "Bu mod, AI Sağlayıcı Ayarlarında şema paylaşımının etkinleştirilmesini gerektirir.",
    ...
    placeholder:
      "Bu veritabanı hakkında sorun, SQL isteyin veya istediğiniz değişikliği açıklayın.",
    ...
    sqlConfirmWriteBody:
      "AI ajanı verileri değiştiren bir ifade çalıştırmak istiyor. Onaylamadan önce gözden geçirin.",
    sqlConfirmHighRiskTitle: "Yüksek riskli SQL çalıştırılsın mı?",
    sqlConfirmHighRiskBody:
      "Bu çalıştırma geri alınamaz şema değişiklikleri uygulayabilir. Her ifadeyi dikkatle inceleyin.",
    ...
    promptIdeas: [
      {
        title: "Tablo oluştur",
        prompt: "id, name, email, role ve created_at içeren bir users tablosu oluştur.",
      },
      {
        title: "Şemayı değiştir",
        prompt: "users tablosuna last_login_at sütunu ekle ve CURRENT_TIMESTAMP ile doldur.",
      },
      {
        title: "Sorgu yaz",
        prompt:
          "Son 30 günde sipariş sayısına göre en çok sipariş veren 10 kullanıcıyı gösteren bir sorgu yaz.",
      },
      {
        title: "Sorguyu optimize et",
        prompt: "Bu SQL'i optimize et: SELECT * FROM orders WHERE DATE(created_at) = CURDATE()",
      },
  ...
  bubbleStates: {
    ...
    loadingInspectPreview:
      "Seçtiğiniz metne bakılıyor, açıklama hazırlanıyor ve uygunsa daha güvenli bir öneri yapılıyor.",
    ...
    selectSomethingError:
      "Önce bir kod veya UI metni seçin, ardından AI balonu inceleme modundayken Enter'a basın.",
    ...
    askUserCustomPlaceholder: "Cevabını yaz…",
    askUserCustomSend: "Gönder",
    openedInWorkspaceTitle: "Çalışma alanında açıldı",
    openedInWorkspaceSubtitle: "Bir çalışma alanı sekmesine gönderildi",
    openedInWorkspacePreview:
      "Bunu bir çalışma alanı sekmesinde açtım, sonucu orada inceleyebilirsin. Bu sohbet, takip soruları için burada kalıyor.",
  ...
  attachments: {
    ...
    managerUsageHint:
      "Ekler yerel olarak depolanır ve disk alanı kaplar. Yer açmak için eski ekleri silin.",
  },
  imageViewer: {
  ...
  workspace: {
    ...
    rebindLockedTitle:
      "Bir ajan çalışıyor — veritabanını değiştirmeden önce bitmesini bekleyin veya iptal edin.",
    dbAuto: "Otomatik",
    ...
    compactNeedsWorkspace:
      "/compact bağlamı kaydedebilsin diye önce bir sohbet çalışma alanı oluştur.",
