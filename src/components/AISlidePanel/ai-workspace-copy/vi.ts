...
export const VI_COPY: AIWorkspaceCopy = {
  ...
  insights: {
    ...
    dismiss: "Bỏ qua",
    reviewFirst: "Cần xem lại trước khi chạy - gợi ý này có thể thay đổi dữ liệu",
    clearAll: "Xóa hết",
  },
  bubbleMeta: {
  ...
  modal: {
    ...
    rewritePlaceholder:
      "Ví dụ: làm nó an toàn hơn cho PostgreSQL, thêm comment, tách DDL và DML, hoặc giải thích join rõ hơn.",
  ...
  composer: {
    ...
    checkpointPreviewBody:
      "Sẽ chạy {statements} câu lệnh ({schema} schema, {data} dữ liệu, {destructive} phá huỷ) vào database hiện tại.",
    ...
    dataReadToggleLabel: "Đọc dữ liệu",
    toggleConfirmTitle: "Xác nhận thay đổi",
    toggleConfirmMessageEnable: 'Bật "{feature}"?',
    toggleConfirmMessageDisable: 'Tắt "{feature}"?',
    toggleConfirmConfirm: "Xác nhận",
    toggleConfirmCancel: "Hủy",
    ...
    sqlConfirmWriteBody:
      "AI agent muốn chạy câu lệnh làm thay đổi dữ liệu. Kiểm tra kỹ trước khi duyệt.",
    sqlConfirmHighRiskTitle: "Chạy SQL rủi ro cao?",
    sqlConfirmHighRiskBody:
      "Lượt chạy này có thể thay đổi cấu trúc DB và không thể hoàn tác. Xem kỹ từng câu lệnh.",
  ...
  bubbleStates: {
    ...
    loadingInspectPreview:
      "Đang xem phần bạn đã chọn, chuẩn bị lời giải thích và gợi ý an toàn hơn nếu phù hợp.",
    ...
    selectSomethingError:
      "Hãy chọn một đoạn code hoặc chữ trên UI trước, rồi nhấn Enter khi orb AI đang ở chế độ inspect.",
    ...
    openedInWorkspacePreview:
      "Mình đã mở cái này trong một tab workspace để bạn xem kết quả ở đó. Đoạn chat này vẫn ở đây để bạn hỏi tiếp.",
  ...
  attachments: {
    ...
    managerUsageHint:
      "Tệp đính kèm được lưu cục bộ và chiếm dung lượng đĩa. Xoá các mục cũ để giải phóng chỗ.",
  },
  imageViewer: {
