...
// Keep this at or below the backend row cap (MAX_QUERY_RESULT_ROWS = 500 in
// src-tauri/src/database/query_common.rs): the driver silently truncates any
// page larger than the cap, which would corrupt `hasMore` detection.
const PAGE_SIZE = 100;
