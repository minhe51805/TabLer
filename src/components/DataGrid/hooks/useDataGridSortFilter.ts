...
interface DataGridSortFilterParams {
  ...
  setMultiSort: Dispatch<
    SetStateAction<Array<{ column: string; direction: "ASC" | "DESC"; priority: number }>>
  >;
...
export function useDataGridSortFilter({
  ...
  const handleFilterChange = useCallback(
    ...
    [setCurrentPage, setFilterDraft],
  );

  /** Add column to multi-sort at specific priority position */
  const handleMultiSortAdd = useCallback(
