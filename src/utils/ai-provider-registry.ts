...
/** Single source of truth for the local Ollama endpoint (UI copy included). */
export const OLLAMA_DEFAULT_ENDPOINT = "http://localhost:11434/v1/chat/completions";
...
export const AI_PROVIDER_REGISTRY: Record<AIProviderType, AIProviderDefinition> = {
  ...
  ollama: {
    ...
    getDefaultEndpoint: () => OLLAMA_DEFAULT_ENDPOINT,
  },
  custom: {
    type: "custom",
    label: "Custom",
